...
class BatchRunner():
    ...
    def __init__(self):
        ...
        if self.method == 'parameter_sweep':
            ...
            var_params = {'utility_at_max':[[[x, x]] for x in [
                            0, 0.2, 0.4, 0.6, 0.8, 1]],
...
for index, row in frame.iterrows():
    ...
    model.simulate()'''.format(frame=self.name))
...
python3 run_batch.py $SLURM_ARRAY_TASK_ID
#python3 ../../datacrawler.py'''.format(name='batchrunner'))
