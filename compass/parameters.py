...
parser.add_argument("--max_move_fraction", type=float, default=0.125,
...
parser.add_argument("--max_school_steps", type=int, default=200,
...
parser.add_argument("--n_neighbourhoods", type=int, default=49,
...
parser.add_argument("--n_schools", type=int, default=49,
...
parser.add_argument("--neighbourhood_mixture", type=float, default=0.2,
                    help="Ratio bounded neighbourhood to local neighbourhood used in Schelling model. \
...
parser.add_argument("--homophily_std", type=float, default=0.02,
...
parser.add_argument("--case", type=str, default='Amsterdam',
...
parser.add_argument("--save_last_only", type=bool, default=False,
