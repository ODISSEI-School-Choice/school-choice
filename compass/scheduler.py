...
class ThreeStagedActivation:
    ...
    def __init__(self, model):
        ...
        self.time, self.split_index, self.moved_agents, self.school_steps, \
            self.residential_steps = 0, 0, 0, 0, 0
    ...
    def add(self, agent):
        ...
        """
        if not agent.__class__.__name__ in list(self._agents.keys()):
    ...
    def step(self, residential=False, initial_schools=False):
        ...
        if residential:
            ...
            # Populate schools after rankings have been calculated
    ...
    def allocate_schools(self, households, initial_schools=False):
        """
        ...
        Args:
            ...
            initial_schools (bool): True if an initial school step needs to be
                performed, False (default) means a school step.
        """
        if self.model.params["n_schools"]:
            if initial_schools:
